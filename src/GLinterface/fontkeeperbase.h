...
public:  
  ...
  Keeper& setFontColor4iv(const GLint* rgba) final {
    return setFontColor4i(rgba[0],rgba[1],rgba[2],rgba[3]);
  }

  Keeper& setFontColor4d(GLdouble red, GLdouble green, GLdouble blue, GLdouble alpha) final {
  ...
  const GLint* getFontColor() const = 0;
};
